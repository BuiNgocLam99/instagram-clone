...
<template>
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url === '/'" id="TopNavHome" class="fixed z-30 md:hidden block w-full bg-white h-[60px] border-b border-b-gray-300">
            <div class="flex items-center justify-between h-full">
                ...
                <div class="flex items-center w-[50%]">
                    <div class="flex items-center w-full bg-gray-200 rounded-lg">
